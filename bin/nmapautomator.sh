...
# Credit to https://github.com/21y4d/nmapAutomator for awesome script! 
# TODO pass in script file path as argument instead this quick hack for moment 
RED='\033[0;31m'
YELLOW='\033[0;33m'
GREEN='\033[0;32m'
NC='\033[0m'
...
$nmapType -T5 --max-retries 1 --max-scan-delay 20 --defeat-rst-ratelimit --open -oN nmap/Quick_$1.nmap $1
assignPorts $1
